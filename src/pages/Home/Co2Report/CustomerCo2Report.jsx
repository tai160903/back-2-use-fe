...
export default function CustomerCo2Report() {
  ...
  useEffect(() => {
    const fetchTotalCo2 = async () => {
      ...
      try {
        const response = await fetcher.get("/borrow-transactions/customer-history", {
          params: {
            status: status || undefined,
            productName: searchText || undefined,
            borrowTransactionType: transactionType || undefined,
      ...
      >
        <Box className="transaction-header" sx={{ mb: 2 }}>
          ...
          <span style={{ color: "#5f6b63" }}>
            Track CO₂ for borrow / return / late return with product details.
          </span>
        </Box>
          ...
          <Box
            sx={{
              ...
              gridTemplateColumns: {
                ...
                md: "0.5fr 1fr 1fr 0.8fr 1.2fr 1fr 1fr",
              },
              gap: 2,
              fontWeight: 800,
              color: "#0b5529",
